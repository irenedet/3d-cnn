...
conserved_points_dir = join(output_dir, "within_mask")
discarded_points_dir = join(output_dir, "outside_mask")
...
if isinstance(filtering_mask_path, float):
    print("Filtering mask file does not exist. All points will be conserved "
          "for the analysis.")
