...
export path_to_model="/g/scb2/zaugg/trueba/3d-cnn/mixed_models/0_UNET_shuffle_mixed_NO_AUG_D_5_IF_4_.pkl"
...
export output_dir='/scratch/trueba/3d-cnn/training_data/TEST/mixed_training/004/train_and_test_partitions/shuffle/NA_confs_4_5_'
