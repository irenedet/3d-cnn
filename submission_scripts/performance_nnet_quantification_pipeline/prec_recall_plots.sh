...
export output_dir="/scratch/trueba/test/motl"
export path_to_motl_clean="/scratch/trueba/3d-cnn/clean/180426_004/motl_clean_fas_4b_iniavg.em"
export path_to_csv_motl="/scratch/trueba/test/motl/fas/in_lamella/motl_3367.csv"
export testing_set_data_path="/scratch/trueba/test/partition_subtomograms_.h5" #set the partition produced by particle picking pipeline
export radius=10
