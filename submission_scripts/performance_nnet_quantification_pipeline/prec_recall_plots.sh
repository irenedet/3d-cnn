...
export path_to_motl_predicted="/struct/mahamid/Irene/yeast/vpp/180426_004/ribos/motl/corrected_motl.csv"
export path_to_motl_true="/struct/mahamid/Irene/yeast/vpp/180426_004/ribos/motl/corrected_motl.csv"
...
#export testing_set_data_path="/scratch/trueba/3d-cnn/training_data/dice-multi-class/004/G_sigma1/train_and_test_partitions/partition_training.h5"
export radius=16
export z_shift=0 # z_shift between original tomogram and subtomogram of partition
export x_shift=-16 # -16 for 004, 16 for 005 (if dataset is square)
export shape_x=928
export shape_y=960
export shape_z=1000
export box=128
