...
export hdf_output_path="/scratch/trueba/test_pr/50_pix_far/redundant/motl_1529_mask.hdf"
export path_to_motl="/scratch/trueba/test_pr/50_pix_far/redundant/motl_1529.csv"
export radius=8
export z_shift=0
export shape_x=928
export shape_y=928
