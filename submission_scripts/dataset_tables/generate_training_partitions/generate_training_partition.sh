...
export global_output_dir="/scratch/trueba/3d-cnn/SPombe_NPC_SU"
...
do
    export output_dir=$global_output_dir"/"$tomo_name"/training_data/strongly_labeled_$min_label_fraction"
    mkdir -p $output_dir
