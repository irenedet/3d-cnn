...
export path_to_dataset_table=""
export global_output_dir="/scratch/trueba/liang_data/classification"
...
python3 pipelines/dice_multi-class/generate_training_set/generate_training_set_from_motl.py