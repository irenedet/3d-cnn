...
training_data_path = \
"/scratch/trueba/3d-cnn/training_data/TEST/mixed_training/004/train_and_test_partitions/data_aug_on_training_split.h5"
...
training_data_path = \
"/scratch/trueba/3d-cnn/training_data/TEST/mixed_training/005/train_and_test_partitions/data_aug_on_training_split.h5"
...
training_data_path = \
"/scratch/trueba/3d-cnn/training_data/TEST/mixed_training/006/train_and_test_partitions/data_aug_on_training_split.h5"
...
for test_index in range(1):
    ...
    for conf in net_confs:
        ...
        model_name = 'UNET_mixed_gauss_sigma1-5_' + \
                     "D_" + str(conf['depth']) + \
