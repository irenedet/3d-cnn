...
python3 /g/scb2/zaugg/trueba/3d-cnn/pipelines/multi-class/evaluation/cnn_subtomo_segmentation.py -model $path_to_model -label $label_name -data_path $output_h5_file_path -init_feat $initial_features -depth $unet_depth -out_classes $output_classes
echo '... done.'
