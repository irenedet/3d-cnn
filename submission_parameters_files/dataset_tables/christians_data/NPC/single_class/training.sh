...
export path_to_dataset_table="/struct/mahamid/Irene/NPC/SPombe/npc_gauss_0.06_masks/DA_NPC_SU_gauss0.06_masks_table.csv"
export segmentation_names='npc'
export split=0.8
# Data for the new model
export models_tag="gauss_0.06_strongly_labeled0.002"
export DA_tag="G1.5_E2_R180_DArounds4"
export log_dir="/g/scb2/zaugg/trueba/3d-cnn/log_"$models_tag
export model_path="/struct/mahamid/Irene/NPC/SPombe/models/NPC_SU_gauss_0.06_strongly_labeled0.002/"
export n_epochs=300
export depth=4
...
export retrain="true"
export path_to_old_model="/struct/mahamid/Irene/NPC/SPombe/models/NPC_SU_gauss_0.06_strongly_labeled0.002/R_false_DA_"$DA_tag"_shuffle_"$shuffle"_npc__D_4_IF_8.pkl"
echo $(ls $path_to_old_model)
export models_notebook="/struct/mahamid/Irene/NPC/SPombe/"$models_tag"/models_npc.csv"
...
#export split=0.8
## Data for the new model
#export models_tag="npc_gauss_0.06_0.01_masks"
#export DA_tag="DA_G1.5_E2_R180"
#export log_dir="/g/scb2/zaugg/trueba/3d-cnn/log_"$models_tag
#export model_path="/g/scb2/zaugg/trueba/3d-cnn/models/npc_christian_yeast_npc/"$models_tag
#export n_epochs=300
#export depth=4
#export initial_features=8
#export output_classes=1
