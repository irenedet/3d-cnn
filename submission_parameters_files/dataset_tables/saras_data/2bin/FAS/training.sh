...
export log_dir="/struct/mahamid/Irene/yeast/FAS_non_sph_masks/2bin/log_"$fractions_name
export model_path="/struct/mahamid/Irene/yeast/models/2bin/"$fractions_name
export n_epochs=150
export depth=4
...
export models_notebook="/struct/mahamid/Irene/yeast/FAS_non_sph_mask_2bin_models.csv"
...
do
  ...
  export model_initial_name="128pix_lr_scheduler_10_R_"$retrain"_encoder_dropout_"$encoder_dropout"_decoder_dropout_"$decoder_dropout"_BN_"$BN"_DA_"$DA"_shuffle_"$shuffle"_frac_"$set"_"
