...
tomo_training_list4="004_4_1,004_4_2,004_4_3,004_4_0"
...
export log_dir="/g/scb2/zaugg/trueba/3d-cnn/log_fractions_004"
export model_path="./models/fractions_004"
export n_epochs=200
export depth=2
...
export models_notebook="/struct/mahamid/Irene/fractions/models_004.csv"
...
do
    ...
    export model_initial_name="shuffle_frac_"$fraction"_"
