...
#fractions="0 1 2 3 4"
#TOMOS="181126_012"
#TOMOS="180426_005 180426_021 181119_002 181119_030 181126_002"
TOMOS="180426_004 180426_005 180426_021 181119_002 181119_030 181126_002 181126_012"
fractions_name="cv_no_eman_filter"
# Tomograms data
...
export path_to_dataset_table="/struct/mahamid/Irene/cross-validation/multiclass/CV_data_no_eman_filter.csv"
DA=none
...
export statistics_file="/struct/mahamid/Irene/cross-validation/multiclass/no_eman_filter_128pix/peak_statistics_class_"$class_number".csv"
...
do
    ...
    do
        # CNN parameters:
        # longer_R_false_encoder_dropout_0_decoder_dropout_0_BN_false_DA_none_shuffle_true_frac_0_ribo_fas_memb__D_2_IF_8
        model_nickname="longer_R_"$retrain"_encoder_dropout_"$encoder_dropout"_decoder_dropout_"$decoder_dropout"_BN_"$BN"_DA_"$DA"_shuffle_"$shuffle"_frac_"$fraction"_ribo_fas_memb__D_"$depth"_IF_"$init_feat
