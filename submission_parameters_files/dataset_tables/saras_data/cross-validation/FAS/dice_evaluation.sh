...
fractions_name="cv_FAS_no_eman_no_aggreg_128pix"
# Tomograms data
...
export statistics_file="/struct/mahamid/Irene/cross-validation/multiclass/FAS_no_eman_no_aggregations_128pix/peak_statistics.csv"
...
do
  ...
  do
  echo $tomo_name
#  R_false_encoder_dropout_0_decoder_dropout_0_BN_false_DA_none_shuffle_true_frac_0_fas__D_2_IF_16.pkl
    model_nickname="R_"$retrain"_encoder_dropout_"$encoder_dropout"_decoder_dropout_"$decoder_dropout"_BN_"$BN"_DA_"$DA"_shuffle_"$shuffle"_frac_"$fraction"_fas__D_"$depth"_IF_"$init_feat
