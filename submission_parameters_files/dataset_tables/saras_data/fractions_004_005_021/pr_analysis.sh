...
export class_number=0 # 0=ribo
export semantic_classes="ribo,fas,memb"
export statistics_file="/struct/mahamid/Irene/fractions_004_005_021/peak_statistics_class_"$class_number".csv"
...
do
    ...
    do
        # CNN parameters:
        model_nickname="shuffle_"$shuffle"_frac_"$fraction"_ribo_fas_memb__D_"$depth"_IF_"$init_feat
        path_to_model="models/fractions_004_005_021/"$model_nickname".pkl"
