...
fractions_name="004_005_021_ED_and_vpp"
# Tomograms data
...
export statistics_file="/struct/mahamid/Irene/fractions_"$fractions_name"/fas/peak_statistics_class_"$class_number".csv"
...
do
    ...
    do
        ...
        path_to_model="models/fractions_"$fractions_name"/"$model_nickname".pkl"
        label_name=$fractions_name"_"$model_nickname
        global_output_dir="/scratch/trueba/3d-cnn/cnn_evaluation/fractions_"$fractions_name"/"$fraction"/"$tomo_name"/"$model_nickname"/pr_radius_"$same_peak_radius_pr_analysis"/peak_calling"
