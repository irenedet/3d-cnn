...
export statistics_file="/struct/mahamid/Irene/fractions/peak_statistics_class_"$class_number".csv"
...
do
    ...
    do
        # CNN parameters:
        model_nickname="Basis_004_005_shuffle_"$shuffle"_frac_"$fraction"_ribo_fas_memb__D_"$depth"_IF_"$init_feat
        path_to_model="models/fractions_004_005/"$model_nickname".pkl"

        global_output_dir="/scratch/trueba/3d-cnn/cnn_evaluation/fractions/$fraction/$tomo_name/"$model_nickname"/pr_radius_"$same_peak_radius_pr_analysis"/peak_calling"
