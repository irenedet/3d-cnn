...
# Tomograms data
export path_to_dataset_table="/struct/mahamid/Irene/yeast/yeast_4bin_fas_double_filter.csv"
DA=none
...
export statistics_file="/struct/mahamid/Irene/cnn_evaluation/FAS/doublefilt_full_tomo_pr_cluster_analysis_64pix.csv"
