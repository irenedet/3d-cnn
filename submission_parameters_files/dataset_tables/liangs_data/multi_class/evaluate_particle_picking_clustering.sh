...
# CNN parameters:
path_to_model="/g/scb2/zaugg/trueba/3d-cnn/models/liang_multi_label/NO_DA_70S_50S_memb_D_2_IF_8.pkl"
model_nickname="NO_DA_70S_50S_memb_D_2_IF_8"
...
score_threshold=-1
global_output_dir="/scratch/trueba/3d-cnn/cnn_evaluation/liang_dataset/multilabel/"$model_nickname"/pr_radius_"$same_peak_radius_pr_analysis"/clustering/"
