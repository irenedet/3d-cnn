...
if [ $class_number == 0 ]; then
    ...
    export statistics_file="/struct/mahamid/Irene/liang_data/test_combined_peak_clusters_statistics.csv"
else
...
label_name="peak_cluster_NO_DA_ribo_D_2_IF_8"
...
# New:
cluster_size_threshold=25000 #sphere//20
...
score_threshold=-1
global_output_dir="/scratch/trueba/3d-cnn/cnn_evaluation/liang_dataset/clusters/test/"$label_name"_pr_radius_"$same_peak_radius_pr_analysis
