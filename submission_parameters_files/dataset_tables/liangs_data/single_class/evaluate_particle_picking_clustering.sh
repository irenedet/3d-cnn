...
if [ $class_number == 0 ]; then
    ...
    export statistics_file="/struct/mahamid/Irene/liang_data/clustering_statistics.csv"
else
...
label_name="clustering_NO_DA_ribo_D_2_IF_8"
