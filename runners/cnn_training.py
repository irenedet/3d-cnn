#! /g/scb2/zaugg/zaugg_shared/Programs/Anaconda/envs/irene/.conda/envs/mlcourse/bin/python3

print("The neural network training is starting")
...
training_data_path = \
    "/scratch/trueba/3d-cnn/training_data/ribosomes/ribo_training.h5"
...
train_data, train_labels, val_data, val_labels = \
    split_dataset(normalized_data, labels, 125)
...
for test_index in range(5):
    ...
    for epoch in range(n_epochs):
        train(net, train_loader,
              ...
              epoch=epoch, log_interval=1, tb_logger=logger)
        step = epoch * len(train_loader.dataset)
        validate(net, val_loader, loss, metric,
                 step=step, tb_logger=logger)
